...
class CustomComponent extends React.Component {
  render() {
    ...
    return (
          <svg width="194px" height="491px" viewBox="0 0 194 491" style={{overflow: 'visible'}}>
            ...
            <g id="Group" transform={` translate(${194/2 * (1-props.scale)},${255* (1-props.scale)}) scale(${props.scale})`}>
